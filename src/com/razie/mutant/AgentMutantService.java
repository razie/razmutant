...
import com.razie.dist.play.phantom.AgentPhantomService;
//import com.razie.playground.filter.AgentFilterService;
...
public class AgentMutantService extends AgentService {
    ...
    protected void onStartup() {
        ...
        agent.register(new AgentPhantomService());
        Log.logThis("CREATE_SERVICE " + "AgentPhatnomService");
