...
TODO SS rewrite optimize
 * 
 */
public class Temp extends SSFilesRazie {
	/**
	 ...
	 */
	public static String getOnlyFileName(String fullFileNm) {
		String result = "";
	...
	public static final Log logger = Log.Factory.create("", Temp.class
			.getName());
