...
{
	private final static String DESCRIPTION_FILE_NAME = "com/razie/upnp/tv/description/description.xml";
	...
	public TvDevice()
	{
		...
		try {
			tvDev = new Device(FileUtils.fileFromUrl(TvDevice.class.getClassLoader().getResource(DESCRIPTION_FILE_NAME)));
		}
