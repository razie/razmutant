...
import org.cybergarage.upnp.RazieDevice;
 ...
 * 
 */
public class JukeboxUpnpDevice extends RazieDevice implements ActionListener, QueryListener {
...
//        this.setHTTPPort(Devices.allocatePort());
        ...
        this.setPresentationURL(Agents.me().url+"/mutant");
