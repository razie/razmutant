...
public class HTTPServer implements Runnable
{
    ...
    public void run()
    {
        ...
        while (httpServerThread == thisThread) {
            ...
            httpServThread.setName("CyberHttpServ"+httpServThread.getName());
            httpServThread.setDaemon(true);
    ...
    public boolean start()
    {
        ...
        /* Razvan 2008-03: name the thread for debugging*/
        httpServerThread.setName("CyberHttpServer"+httpServerThread.getName());
