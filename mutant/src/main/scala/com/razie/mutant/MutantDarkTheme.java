...
public class MutantDarkTheme extends HtmlTheme {
    static String[] tags = {
      "<head><link rel=\"stylesheet\" type=\"text/css\" href=\"/mutant/style.css\" /><script type=\"text/javascript\" src=\"/mutant/scripts.js\"></script></head><body link=\"yellow\" vlink=\"yellow\">",
      "</body>", "<html>", "</html>" };
